...
foreach ($fraisHorsForfait as $lesFraisF){
    ...
    $pdf->Cell(80,7,utf8_decode($lesFraisF[3]),1,0,"C");
    $pdf->Cell(50,7,$lesFraisF[5],1,0,"C");
    $pdf->Ln(7);
}
$pdf->Ln(20);
...
header("Content-Disposition: attachment; filename = suiviFrais.pdf");
header("Content-Transfer-Encoding: 'fpdf/pdf'\n");
header("Pragma: no-cache");
header("Cache-Control: must-revalidate, post-check=0, pre-check=0, public");
header("Expires: 0");
readfile("fpdf/suiviFrais.pdf");